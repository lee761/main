...
==== Documentation:
* Added documentations for my features in the developer guide and user guide, which includes some use cases
and test guide.
...
made for Natural Date Format, priority, snooze and clear features.
